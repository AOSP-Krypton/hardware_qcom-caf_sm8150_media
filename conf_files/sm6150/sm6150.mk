CONFIG_PATH := $(call get-caf-path,media)/conf_files/$(MSMSTEPPE)
...
ifeq ($(GENERIC_ODM_IMAGE)$(TARGET_BOARD_AUTO),truetrue)
  ...
  DEVICE_MANIFEST_FILE += $(call get-caf-path,media)/conf_files/sm6150/c2_manifest_vendor.xml
  ...
  DEVICE_MANIFEST_FILE += $(call get-caf-path,media)/conf_files/sm6150/c2_manifest.xml
  ...
  PRODUCT_COPY_FILES += \
    ...
    DEVICE_MANIFEST_FILE += $(call get-caf-path,media)/conf_files/msmnile/c2_manifest.xml
    PRODUCT_COPY_FILES += \
      device/qcom/common/media/media_profiles.xml:$(TARGET_COPY_OUT_ODM)/etc/media_profiles_V1_0.xml \
      device/qcom/common/media/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_vendor.xml
endif
